...
interface IRedstoneAdapter {
    ...
    function getValuesForDataFeeds(
        bytes32[] memory requestedDataFeedIds
    ...
    function getDataTimestampFromLatestUpdate()
        external
        view
        returns (uint256 lastDataTimestamp);
     ...
     */
    function getBlockTimestampFromLatestUpdate()
        external
        view
     ...
     */
    function validateProposedDataPackagesTimestamp(
